...
# Process data for valence == 0 and valence > 0
...
forecast_steps = 60  # You can adjust this based on your needs

# Create future exogenous variables (e.g., assume `has_event` remains the same or adjust as needed)
future_exog_valence_0 = [[0]] * forecast_steps  # Assuming no events for valence == 0
future_exog_valence_positive = [[1]] * forecast_steps  # Assuming events for valence > 0
